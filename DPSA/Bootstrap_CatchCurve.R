BootStrap_CatchCurve<- function(LengthDat,CatchCurveWeight,WeightedRegression, ReserveYr,OutsideBoundYr,ManualM,Iterations,BootStrap,LifeError,HistInterval,BootSampleSize)
{
  ##################
  ###### BootStrapCatchCurve ######
  ##################
